...
public class DES_Decryption {
	...
	private int[] shift_left(int[] data, int n) {
        ...
        System.arraycopy(data, n, ans, 0, data.length - n);
        System.arraycopy(data, 0, ans, data.length - n, n);
        return ans;
    }
	...
	private String string2binary(String string) {
        ...
        for (int i = 0; i < string.length(); i++) {
            ...
            // Chuyển đổi từng ký tự thành giá trị nhị phân ASCII
            String binaryString = Integer.toBinaryString(c);
            // Đảm bảo rằng mỗi ký tự nhị phân được lưu trữ với đúng 8 bits
